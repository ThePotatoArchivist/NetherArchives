...
object WorldGen {
    ...
    private val MAGNETITE_BLOBS = RegistryKey.of(RegistryKeys.PLACED_FEATURE, Identifier(NetherArchives.NAMESPACE, "magnetite_blobs"))
    ...
    fun addFeatures() {
        ...
        BiomeModifications.addFeature(BiomeSelectors.includeByKey(BiomeKeys.BASALT_DELTAS), GenerationStep.Feature.SURFACE_STRUCTURES, MAGNETITE_BLOBS)
    }
}
