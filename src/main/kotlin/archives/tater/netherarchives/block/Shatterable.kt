...
interface Shatterable {
    ...
    fun onProjectileHit(
        ...
        if (world !is ServerLevel || !projectile.mayInteract(world, pos) || !projectile.mayBreak(world) || projectile.type isIn NetherArchivesTags.NON_SHATTER_PROJECTILES) return
